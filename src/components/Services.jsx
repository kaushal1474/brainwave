        ...
        <Section id="how-to-use">
            <div className='container'>
                <Heading
                    ...
                    text="Brainwave unlockes the potential of AI-powered applications"
                />
                ...
                <div>
                    <div className='relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]'>
                        ...
                        <Generating className='absolute left-4 right-4 bottom-4 border border-n-1/10 lg:left-1/2 lg:bottom-8 lg:-translate-x-1/2 text-base' />
                    </div>
                            ...
                            <div className='py-12 px-4 xl:px-8'>
                                ...
                                <ul className='flex justify-between items-center'>
                                    {brainwaveServicesIcons.map((item, index) =>
                                        <li key={item}
                                            className={`flex items-center justify-center rounded-2xl ${index === 2 ? "w-12 h-12 p-0.25 bg-conic-gradient md:w-[4.5rem] md:h-[4.5rem]" : "w-10 h-10 bg-n-6 md:w-15 md:h-15"}`}
                                        >
                                            <div className={index === 2 ? "w-full h-full bg-n-7 rounded-2xl flex justify-center items-center" : ""}>
